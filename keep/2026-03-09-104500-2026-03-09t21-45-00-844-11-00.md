...
> created_ts: 2026-03-09-104500  
> Created: 2026-03-09 10:45 UTC  
> Edited: 2026-03-09 10:45 UTC  
> Source: Google Keep  

---

You are debugging a Linux system where something is autonomously navigating keyboard input — it navigated through MSI BIOS menus to CPU Core Voltage Offset settings without any user input. The machine runs locally with no remote access. I was doing terminal/dashboard work on a locally-running AI system (Python, event loop based) before this started. Check: any processes writing to /dev/input, any xdotool/evemu/dotool processes, any Python code with keyboard/input libraries, any udev rules or systemd services that could generate input events. Show me what you find.

---

## Related notes

→ [[keep/2025-10-03-120206-2025-10-03t22-04-36-490-10-00]]
→ [[keep/2025-08-29-113355-2025-08-29t21-33-56-332-10-00]]
→ [[keep/2026-03-10-051017-2026-03-10t16-10-19-545-11-00]]
