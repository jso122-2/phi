...
SPECS: tuple[CommandSpec, ...] = (
    ...
    _mcp("diagnose", "agent_context", _CTX, "Targeted diagnose and evaluate.",
         defaults={"mode": "diagnose"}, init_free=True),
    _mcp("evaluate", "agent_context", _CTX, "Alias for /diagnose — root cause then evaluate.",
         defaults={"mode": "diagnose"}, init_free=True),
